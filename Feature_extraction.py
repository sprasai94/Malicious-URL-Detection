...
def safebrowsing(url):
    ...
    try:
        ...
        if res.code==204:
            ...
            print("Service Unavailable The server cannot handle the request. Besides the normal server failures, "
                  "it could also indicate that the client has been throttled by sending too many requests")
    except:
        return -1
